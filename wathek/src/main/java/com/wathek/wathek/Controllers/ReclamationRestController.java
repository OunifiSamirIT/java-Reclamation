...
import com.wathek.wathek.dto.ReclamationDTO;
...
public class ReclamationRestController {
    ...
    @Autowired
     IReclamationServices reclamationService;
...
//    public ResponseEntity<?> addRecReduction(@RequestBody ReclamationRequest reclamation) {
//
//        Reclamation saved = reclamationServices.ajouterReclamationRedcution(reclamation);
//        URI location = ServletUriComponentsBuilder
//                .fromCurrentRequest()
//                .path("/{id}")
//                .buildAndExpand(saved.getIdRec()).toUri();
